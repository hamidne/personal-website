			...
			items: [
				{
					title: 'FrontEnd',
					items: [
						{ title: 'Nuxt.js', subtitle: 'Advanced - 2 year' },
						{ title: 'Vue.js', subtitle: 'Advanced - 3 year' },
						{ title: 'HTML', subtitle: 'WORDPRESS/PHP' },
						{ title: 'CSS', subtitle: 'ANDROID/IOS' },
						{ title: 'SCSS', subtitle: 'ANDROID/IOS' },
						{ title: 'LESS', subtitle: 'ANDROID/IOS' },
						{ title: 'Webpack', subtitle: '' },
						{ title: 'JQuery', subtitle: '' },
						{ title: 'Vuex', subtitle: '' },
						{ title: 'JavaScript', subtitle: '' },
						{ title: 'ES6 / ES7 / ES8', subtitle: '' },
						{ title: 'Jest', subtitle: '' },
						{ title: 'Cypress', subtitle: '' },
						{ title: 'Puppeteer', subtitle: '' },
						{ title: 'WebScrapping', subtitle: '' },
						{ title: 'Electron.js', subtitle: '' },
						{ title: 'Bootstrap', subtitle: '' },
						{ title: 'Vuetify', subtitle: '' },
						{ title: 'ElementUI', subtitle: '' },
						{ title: 'TailwinCSS', subtitle: '' },
						{ title: 'MaterialUI', subtitle: '' },
						{ title: 'Balma', subtitle: '' },
						{ title: 'WebRTC', subtitle: '' },
						{ title: 'ServiceWorker', subtitle: '' },
						{ title: 'PWA', subtitle: '' },
						{ title: 'VideoStreaming', subtitle: '' },
						{ title: 'WebSocket', subtitle: '' },
						{ title: 'FireBase', subtitle: '' },
					],
				},
				{
					title: 'BackEnd',
					items: [
						{ title: 'PHP', subtitle: '' },
						{ title: 'Laravel', subtitle: '' },
						{ title: 'Node.js', subtitle: '' },
						{ title: 'Nginx', subtitle: '' },
						{ title: 'MongoDB', subtitle: '' },
						{ title: 'Docker', subtitle: '' },
						{ title: 'Git', subtitle: '' },
						{ title: 'MySql', subtitle: '' },
						{ title: 'Redis', subtitle: '' },
					],
				},
				{
					title: 'DevOps',
					items: [
						{ title: 'Nginx', subtitle: '' },
						{ title: 'Docker', subtitle: '' },
						{ title: 'Kubernetes', subtitle: '' },
						{ title: 'Openshift', subtitle: '' },
						{ title: 'JamStack', subtitle: '' },
						{ title: 'GitLab CI/CD', subtitle: '' },
					],
				},
				{
					title: 'Operating System',
					items: [
						{ title: 'Macintosh', subtitle: '2 Year' },
						{ title: 'CentOS', subtitle: '3 Year' },
						{ title: 'Ubuntu', subtitle: '5 Year' },
						{ title: 'Windows', subtitle: '15 Year' },
					],
				},
			],
		},
