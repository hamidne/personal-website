	...
	<div class="main-page-wrapper">
				...
				<div class="inner-content">
					...
					<div class="profile-tab">
						...
						<ul class="nav nav-tabs hide-pr">
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab" href="#myself"
									>Myself.</a
								>
							</li>
							<li class="nav-item">
						...
						<div class="tab-content">
							<div id="myself" class="tab-pane active">
								<p>
									...
									<span>award winning Digital Designer & Developer</span> with
									over <span>five years work experience</span>. I started in my
									children’s room, got pro at renowned digital agencies
									<span>akij co</span> and nork <span>blue lebel</span>. Now I’m
									based in Dhaka, Bangladesh, working for
									<span>Apple</span> fredmansky and enjoying the life in the
									countryside.
								</p>
							</div>
							<div id="education" class="tab-pane fade">
								<p>
									...
									<span>Bachelor of Arts in Advertising;</span> Minor: Spanish;
									GPA: 3.35, anticipated in May 2014
								</p>
								<div class="tag">Notable Accomplishments:</div>
								<ul>
									<li>Dean's List: Fall 2011, Spring 2018</li>
									<li>
										Awarded Best Advertising Campaign Proposal for Health
										Committee, State University, Spring 2013
									</li>
								</ul>
							</div>
							<div id="skill" class="tab-pane fade">
								<p>
									Sed ut perspiciatis
									<span>unde omnis iste natus error sit</span> voluptatem
		...
		<div class="section-portfo our-service-portfo">
			...
			<div class="container">
				<div class="title-wrapper">
					...
					<p>
						Lorem ipsum dolor sit amet, ut mea inciderint ullamcorper. Mei
						putant deleniti
					</p>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="service-block" data-aos="flip-right">
							...
							<h5 class="title">
								<a href="#">User Experience & Interface Design.</a>
							</h5>
							<p>
								Extreme attention to detail is the essence of et Boo’s unique
								design concepts. In mals alienum scripserit sea, in alia aliquid
					...
					<div class="col-lg-6">
						<div class="service-block" data-aos="flip-right">
							...
							<h5 class="title">
								<a href="#">Social Media & Online Marketing.</a>
							</h5>
							<p>
								Extreme attention to detail is the essence of et Boo’s unique
								design concepts. In mals alienum scripserit sea, in alia aliquid
					...
					<div class="col-lg-6">
						<div class="service-block" data-aos="flip-right">
							...
							<h5 class="title">
								<a href="#">Mobile Application & Game Development.</a>
							</h5>
							<p>
								Extreme attention to detail is the essence of et Boo’s unique
								design concepts. In mals alienum scripserit sea, in alia aliquid
		...
		<div class="section-portfo our-project-portfo">
			...
			<div class="text-content">
				<div class="container">
					<p>
						Die CI Farben von Millhaus sind schwarz . Nett aber auch
						herausfoernd. Anfangs probierten, uns abert z.
					</p>
				</div>
				<a
							...
							<div class="agn-testimonial-slider">
								<div class="item">
									<p>
										...
										life. The problem still stands, when it comes timeadvertise
										your business for a cheap cost. I know you have looked for
